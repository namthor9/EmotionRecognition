# -*- coding: utf-8 -*-
"""
Created on Thu Dec 16 12:27:03 2021
...
for file in os.scandir(datapath):
    ...
    for i in range(40):
        ...
        if(vale != 0):
            ...
            new_sample.append(aro)
            new_sample.append(like)        
            x_data.append(new_sample)
    
         
export_frame = pd.DataFrame(x_data)
export_frame.to_csv("C:/Users\MaxRo\OneDrive\Desktop\BCIRESEARCH\DEAP_PROCESSED_EMD_F7F8_aro.csv",index=False,header=False)
