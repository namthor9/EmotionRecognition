...
for file in os.scandir(datapath):
    ...
    for i in range(40):
        ...
        features = []
        imf = emd.sift.sift(rawdata[F8],max_imfs=2)
...
export_frame.to_csv("C:/Users\MaxRo\OneDrive\Desktop\BCIRESEARCH\DEAP_PROCESSED_EMD_F8.csv",index=False,header=False)
