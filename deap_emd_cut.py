# -*- coding: utf-8 -*-
"""
Created on Mon Nov 29 13:35:15 2021
...
for file in os.scandir(datapath):
    ...
    for i in range(40):
        ...
        #times = numpy.linspace(0,60,25) ##5 second windows
        times = numpy.linspace(0,60,3) ##15 second windows
...
export_frame.to_csv("C:/Users\MaxRo\OneDrive\Desktop\BCIRESEARCH\DEAP_PROCESSED_EMD_F7F8_15sec.csv",index=False,header=False)
