# -*- coding: utf-8 -*-
"""
Created on Thu Dec 16 10:45:53 2021
...
em_labels = []
ld_labels = []
datadir= "C:/Users\MaxRo\OneDrive\Desktop\BCIRESEARCH\DEAP_PROCESSED_EMD_F7F8_30sec.csv"
...
model.add(Conv1D(filters=64, kernel_size=2, activation='relu', input_shape=(features_len,1),strides=1))
...
model.fit(train_array, y_train, epochs=250, batch_size=32, verbose=0)
	# evaluate model
